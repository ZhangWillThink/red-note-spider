  ...
  ;((c.m = i),
    ...
    (function () {
      if (void 0 !== c) {
        var e = c.e,
          t = c.p,
          n = ['//fe-static-backup.xhscdn.com', '//fe-static.xhscdn.net'].sort(
            function () {
        ...
        c.e = function (i) {
          ...
          return (
            (c.p = u === r ? t : t.replace('//fe-static.xhscdn.com', n[u])),
...
function dec2hex(e, t) {
  for (var r = '', n = e; n; ) {
    var o = 15 & n
    ;((r = String.fromCharCode((o > 9 ? 55 : 48) + o) + r), (n >>= 4))
  }
  if (t) for (; r.length < t; ) r = '0'.concat(r)
  return r.toLowerCase()
}
function urlSing(e) {
  var t
  return md5_default()(
    instance_concat_default()((t = 'hIJXulBFYcGRQjrz'.concat(e))).call(
      t,
      dec2hex(now_default()() / 1e3),
    ),
  )
}
